...
public class HashMapAdapter<K> extends HashMap<K, K> implements Map<K, K>, Cloneable, Serializable {
	...
	public HashMapAdapter(int initialCapacity, float loadFactor) throws IllegalArgumentException {
	...
	public HashMapAdapter(Map<? extends K, ? extends K> map) throws NullPointerException {
		super(map);
	}
}